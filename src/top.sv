...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 76   // Instantiated from top.tlv, 180 as: m5+tt_connections()
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 183 as: m5+board(/top, /fpga, 7, $, , calc)
         ...
         //_/fpga
            //_\source top.tlv 49   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+calc.
               ...
               //_|calc
                  ...
                  //_@1
                     assign FpgaPins_Fpga_CALC_valid_a1[0:0] = FpgaPins_Fpga_CALC_reset_a1 ? 0 : FpgaPins_Fpga_CALC_equals_in_a1 && ! FpgaPins_Fpga_CALC_equals_in_a2 ;
                  ...
                  //_@2
                     assign FpgaPins_Fpga_CALC_out_a2[7:0] = FpgaPins_Fpga_CALC_reset_a2 ? 8'b0 :
                                 ! FpgaPins_Fpga_CALC_valid_a2 ? FpgaPins_Fpga_CALC_out_a3[7:0] :
                                 ...
                                 FpgaPins_Fpga_CALC_op_a2[2:0] == 3'b100 ? FpgaPins_Fpga_CALC_mem_a4[7:0] : FpgaPins_Fpga_CALC_out_a3[7:0];
                     ...
                     assign uo_out =
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'h0
                           ? 8'b00111111 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'h1
                           ? 8'b00000110 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'h2
                           ? 8'b01011011 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'h3
                           ? 8'b01001111 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'h4
                           ? 8'b01100110 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'h5
                           ? 8'b01101101 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'h6
                           ? 8'b01111101 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'h7
                           ? 8'b00000111 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'h8
                           ? 8'b01111111 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'h9
                           ? 8'b01101111 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'ha
                           ? 8'b01110111 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'hb
                           ? 8'b01111100 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'hc
                           ? 8'b00111001 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'hd
                           ? 8'b01011110 :
                        FpgaPins_Fpga_CALC_digit_a2[3:0] == 4'he
                           ? 8'b01111001 :
                             8'b01110001;
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 185 as: m5+tt_input_labels_viz(⌈"Value[0]", "Value[1]", "Value[2]", "Value[3]", "Op[0]", "Op[1]", "Op[2]", "="⌉)
